...
export default function HomePage() {
  return (
    <div className="govuk-!-margin-top-6 govuk-!-margin-bottom-6">
      <section className="govuk-grid-row govuk-!-margin-bottom-8">
        <div className="govuk-grid-column-two-thirds">
          ...
          <div className="trust-badge govuk-!-margin-top-3">
        ...
        <div className="govuk-grid-column-one-third">
          <div className="govuk-panel govuk-panel--confirmation govuk-!-margin-bottom-3">
            <h3 className="govuk-heading-m govuk-!-margin-bottom-1">Student safety is our priority</h3>
