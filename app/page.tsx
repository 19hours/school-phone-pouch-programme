    ...
    <div className="space-y-12 pb-12 md:space-y-16 md:pb-16">
      <section className="section grid gap-10 md:grid-cols-2 md:items-center">
        <div className="space-y-6">
          <div className="inline-flex rounded-full bg-blue-50 px-4 py-2 text-sm font-semibold text-primary">School-ready programme</div>
          ...
          <CTAButtons />
          <div className="grid gap-1 text-sm text-slate-700 md:grid-cols-2 md:text-base">
            <div className="rounded-lg bg-white/70 px-4 py-3 shadow-sm">Chu Technologies Pte Ltd (UEN: 201926755K).</div>
            <div className="rounded-lg bg-white/70 px-4 py-3 shadow-sm">Government registered vendor on vendors@gov, since 2019.</div>
          </div>
        </div>
        <div className="relative h-72 overflow-hidden rounded-2xl bg-gradient-to-br from-blue-700 via-blue-500 to-blue-400 shadow-xl md:h-[420px]">
          <Image
      ...
      <section className="section space-y-6">
        ...
        <ul className="grid gap-4 md:grid-cols-2">
          {["Students are often distracted by smartphones.", 'Schools and exam centres need simple, visible compliance.', 'Bags and pockets still allow discreet phone use.', 'Administrators need a consistent, easy-to-audit solution.'].map((item) => (
            <li key={item} className="card text-base text-slate-800 md:text-lg">
              {item}
            </li>
          ))}
        </ul>
      ...
      <section className="section space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="card space-y-3 bg-slate-50 text-base text-slate-800 md:text-lg">
            <p className="text-xl font-semibold text-slate-900">Highlights</p>
      ...
      <section className="section grid gap-6 md:grid-cols-2 md:items-center">
        ...
        <div className="relative h-64 overflow-hidden rounded-2xl bg-gradient-to-r from-primary to-secondary shadow-lg md:h-72">
          <Image
      ...
      <section className="section rounded-2xl bg-primary px-6 py-10 text-white shadow-lg">
